...
public class UpdateManager {
    ...
    public void updateApp(OnCancelListener cancelListener) {
    ...
    private void showDownloadDialog() {
        ...
        if (freeDiskSize < 52428800) {//50 * 1024 * 1024
            App.getInstance().showToast(mContext.getString(R.string.no_more_free_disk));
        } else {
            ...
            downloadTv = v.findViewById(R.id.download_noteTv);
            builder.setView(v);
    ...
    private void installApk() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(mContext, "com.xueli.application.fileprovider", apkFile);
