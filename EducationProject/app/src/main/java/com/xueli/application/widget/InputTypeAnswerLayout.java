...
public class InputTypeAnswerLayout extends LinearLayout {
    ...
    public InputTypeAnswerLayout(Context context) {
        super(context);
        init(context);
    }

    private void init(Context context) {
        inflate(context, R.layout.input_type_ansower_layout, this);
